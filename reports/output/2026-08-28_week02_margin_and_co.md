...
Buy & hold, the benchmark, returned a Sharpe of **1.51** over the same out-of-sample window.

## The decay curve

![Sharpe decay by indicator](decay_curve_week02.png)
...
|---|---:|---:|---:|---:|---:|---:|---:|:---:|
| EMA | -0.15 | -0.78 | -0.84 | 60,438 | 12.6% | -30.5% | 51.5% | FAILED |
| MACD | 0.15 | -0.35 | -0.62 | 249,678 | 52.3% | -25.1% | 43.2% | FAILED |
| RSI | 0.12 | 0.55 | 0.48 | 86,771 | 9.4% | -6.4% | 46.5% | WEAKENED |
| VWAP | -0.19 | -0.29 | -0.70 | 379,028 | 79.4% | -27.1% | 44.1% | FAILED |
| *Buy & hold* | 0.86 | 1.51 | 1.51 | 0 | 0.1% | -14.3% | — | *benchmark* |
...
**EMA** posted a -0.15 Sharpe in-sample, -0.78 out-of-sample, and -0.84 once trading costs were applied (60,438 trades, 12.6% of notional paid away).

### MACD — FAILED

*Trend-following: long while the MACD line (EMA12-EMA26) is above its 9-day signal line.*

**MACD** posted a 0.15 Sharpe in-sample, -0.35 out-of-sample, and -0.62 once trading costs were applied (249,678 trades, 52.3% of notional paid away).

### RSI — WEAKENED

*Mean-reversion: buy below RSI 30, short above RSI 70, flatten back at 50.*

**RSI** posted a 0.12 Sharpe in-sample, 0.55 out-of-sample, and 0.48 once trading costs were applied (86,771 trades, 9.4% of notional paid away).

### VWAP — FAILED

*Trend-following: long while the close is above the 20-day rolling volume-weighted average price.*

**VWAP** posted a -0.19 Sharpe in-sample, -0.29 out-of-sample, and -0.70 once trading costs were applied (379,028 trades, 79.4% of notional paid away).
...
|---|---:|---:|---:|---:|
| EMA | 6 | -0.43 | 16.7% | -1.50 |
| MACD | 6 | -0.39 | 50.0% | -2.07 |
| RSI | 6 | 0.14 | 50.0% | -0.64 |
| VWAP | 6 | -0.87 | 16.7% | -1.96 |

## Growth of 1.00, net of costs

![Equity curves](equity_curves_week02.png)

## How wrong could the cost assumption be?

![Cost sensitivity](cost_sensitivity_week02.png)
...
*Generated 2026-08-28 by the Margin & Co. pipeline. Code and data are open: every number above can be reproduced by running `python run_pipeline.py`.*